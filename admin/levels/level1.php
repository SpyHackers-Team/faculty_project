<?php 
    ...
    */
    ...
    else header("Location: ../levels.php");
...
?>
        ...
        <section class="attend-table grid">
            <div class="caption grid">
                <a class="absent_btn" href="../weeks/week1.php">get</a>
                <h2>Attendance Table Level 1</h2>
                ...
                <div>
                    <div class="modal hidden grid">
                        ...
                        <form class="grid" method="POST" action="../backend/newStudent.php">
                            ...
                            <input class="next" type="submit" value="Submit" name="add1">
                        </form>
                    </div>
...
<?php
    ...
    // Select All Student
    $stmt = $con->prepare("SELECT * FROM student_account st, student_one sr WHERE st.UserID = sr.Student_ID And ");
