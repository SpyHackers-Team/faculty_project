...
?>
        ...
        <section class="attend-table grid">
            <div class="caption grid">
                <a class="absent_btn" href="../weeks/week2.php">get</a>
                <h2>Attendance Table Level 2</h2>
                ...
                <div>
                    <div class="modal hidden grid">
                        ...
                        <form class="grid" method="POST" action="../backend/newStudent.php">
                            ...
                            <input class="next" type="submit" value="Submit" name="add2">
                        </form>
                    </div>
...
<?php
    ...
    $stmt = $con->prepare("SELECT * FROM `student_two`");
                    ...
                    <tbody>
                        ...
                        foreach($rows as $row) {
                            ...
                            echo '<td class="admin-opt grid">
                                        <a href="../backend/deleteStudent.php"><i class="fas fa-minus-circle"></i> Delete</a>
