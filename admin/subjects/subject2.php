<?php 
    ...
    $_SESSION['url']='subjects/subject2.php';
...
?>
        <center>
            <h1 style="
                ...
                <?php if (isset($_SESSION['lang']) && $_SESSION['lang'] == 'ar') echo '<a class="add-btn" href="#"><i class="fas fa-plus-circle"></i></a> '; echo lang('SUBJECT_SECOND_YEAR'); if (!isset($_SESSION['lang']) || $_SESSION['lang'] == 'en') echo ' <a class="add-btn" href="#"><i class="fas fa-plus-circle"></i></a>';?>
            </h1>
        </center>
        <div>
            <div class="modal hidden grid">
                ...
                <form class="grid" method="POST" action="../backend/newSubject.php?do=second" enctype="multipart/form-data">
                    <div class="add-form grid">
                        <div class="grid">
                            <label>Subject Name</label>
                            <input type="text" name="subject" placeholder="first name..." required>
                        </div>
                        <div class="grid">
...
<?php 
    $stmt = $con->prepare("SELECT * FROM `subject` WHERE `SubjectYear` = 2");
    $stmt->execute();
    $rows = $stmt->fetchAll();
?>
