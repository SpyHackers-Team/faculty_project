<?php
    ...
    $stmt = $con->prepare("SELECT * FROM student_account WHERE YearID = 2");
    $stmt->execute();
    $rows = $stmt->fetchAll();
            ...
            <div>
                ...
                <div class="modal modal1 hidden week-modal" id="modal">
                    ...
                    <form class="attendance-popup" method="POST" action="backend/takeAbsence.php">
                        ...
                        <input type="submit" value="Submit" name="week9">
                    </form>
                </div>
                <!-- =================== modal2 pop-up =================== -->
                <div class="modal modal2 hidden week-modal" id="modal">
                    ...
                    <form class="attendance-popup" method="POST" action="backend/takeAbsence.php">
                        ...
                        <input type="submit" value="Submit" name="week10">
                    </form>
                </div>
                <!-- =================== modal3 pop-up =================== -->
                <div class="modal modal3 hidden week-modal" id="modal">
                    ...
                    <form class="attendance-popup" method="POST" action="backend/takeAbsence.php">
                        ...
                        <input type="submit" value="Submit" name="week11">
                    </form>
                </div>
                <!-- =================== modal4 pop-up =================== -->
                <div class="modal modal4 hidden week-modal" id="modal">
                    ...
                    <form class="attendance-popup" method="POST" action="backend/takeAbsence.php">
                        ...
                        <input type="submit" value="Submit" name="week12">
                    </form>
                </div>
                <!-- =================== modal5 pop-up =================== -->
                <div class="modal modal5 hidden week-modal" id="modal">
                    ...
                    <form class="attendance-popup" method="POST" action="backend/takeAbsence.php">
                        ...
                        <input type="submit" value="Submit" name="week13">
                    </form>
                </div>
                <!-- =================== modal6 pop-up =================== -->
                <div class="modal modal6 hidden week-modal" id="modal">
                    ...
                    <form class="attendance-popup" method="POST" action="backend/takeAbsence.php">
                        ...
                        <input type="submit" value="Submit" name="week14">
                    </form>
                </div>
                <!-- =================== modal7 pop-up =================== -->
                <div class="modal modal7 hidden week-modal" id="modal">
                    ...
                    <form class="attendance-popup" method="POST" action="backend/takeAbsence.php">
                        ...
                        <input type="submit" value="Submit" name="week15">
                    </form>
                </div>
                <!-- =================== modal8 pop-up =================== -->
                <div class="modal modal8 hidden week-modal" id="modal">
                    ...
                    <form class="attendance-popup" method="POST" action="backend/takeAbsence.php">
                        ...
                        <input type="submit" value="Submit" name="week16">
                    </form>
                </div>
