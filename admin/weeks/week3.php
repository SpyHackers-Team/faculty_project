<?php
    ...
    $stmt = $con->prepare("SELECT * FROM student_account WHERE YearID = 3");
    $stmt->execute();
    $rows = $stmt->fetchAll();
            ...
            <div>
                ...
                <div class="modal modal1 hidden week-modal" id="modal">
                    ...
                    <form class="attendance-popup" method="POST" action="backend/takeAbsence.php">
                        ...
                        <input type="submit" value="Submit" name="week17">
                    </form>
                </div>
                <!-- =================== modal2 pop-up =================== -->
                <div class="modal modal2 hidden week-modal" id="modal">
                    ...
                    <form class="attendance-popup" method="POST" action="backend/takeAbsence.php">
                        ...
                        <input type="submit" value="Submit" name="week18">
                    </form>
                </div>
                <!-- =================== modal3 pop-up =================== -->
                <div class="modal modal3 hidden week-modal" id="modal">
                    ...
                    <form class="attendance-popup" method="POST" action="backend/takeAbsence.php">
                        ...
                        <input type="submit" value="Submit" name="week19">
                    </form>
                </div>
                <!-- =================== modal4 pop-up =================== -->
                <div class="modal modal4 hidden week-modal" id="modal">
                    ...
                    <form class="attendance-popup" method="POST" action="backend/takeAbsence.php">
                        ...
                        <input type="submit" value="Submit" name="week20">
                    </form>
                </div>
                <!-- =================== modal5 pop-up =================== -->
                <div class="modal modal5 hidden week-modal" id="modal">
                    ...
                    <form class="attendance-popup" method="POST" action="backend/takeAbsence.php">
                        ...
                        <input type="submit" value="Submit" name="week21">
                    </form>
                </div>
                <!-- =================== modal6 pop-up =================== -->
                <div class="modal modal6 hidden week-modal" id="modal">
                    ...
                    <form class="attendance-popup" method="POST" action="backend/takeAbsence.php">
                        ...
                        <input type="submit" value="Submit" name="week22">
                    </form>
                </div>
                <!-- =================== modal7 pop-up =================== -->
                <div class="modal modal7 hidden week-modal" id="modal">
                    ...
                    <form class="attendance-popup" method="POST" action="backend/takeAbsence.php">
                        ...
                        <input type="submit" value="Submit" name="week23">
                    </form>
                </div>
                <!-- =================== modal8 pop-up =================== -->
                <div class="modal modal8 hidden week-modal" id="modal">
                    ...
                    <form class="attendance-popup" method="POST" action="backend/takeAbsence.php">
                        ...
                        <input type="submit" value="Submit" name="week24">
                    </form>
                </div>
